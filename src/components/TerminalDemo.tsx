...
export function TerminalDemo() {
  return (
    <Link href="/terminal" className="group relative w-full max-w-lg block transition-transform hover:scale-[1.02] active:scale-[0.98]">
      ...
      <Terminal sequence={false} className="w-full max-w-full cursor-pointer shadow-lg hover:shadow-xl transition-shadow relative">
        <TypingAnimation delay={3000} duration={30}>&gt; initializing linlin-blog v1.500...</TypingAnimation>
        ...
        <TypingAnimation delay={4500} duration={15} className="text-amber mt-4 block whitespace-pre">
          {`lin {                             |
    name: "lin lin",              |
    gender: "male",               |
    age: 22,                      v
