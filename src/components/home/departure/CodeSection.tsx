...
I will try my best to update and enrich the content of this site in the future.
    ...
    <div className="relative w-full pt-12 overflow-visible">
      ...
      <div className="w-full flex flex-col lg:flex-row items-stretch relative z-30">
        ...
        <div className="w-full lg:w-[50%] flex flex-col pt-12 lg:pt-0">
          ...
          <div className="w-full grow flex items-end justify-end bg-transparent relative pl-11 max-[767px]:pl-4 lg:pl-10">
